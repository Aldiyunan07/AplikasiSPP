...
<head>
	...
	<?php
			...
			header("content-disposition: attachment;filename=Laporan Data Siswa.doc");
	?>
<body>
...
<head>
	...
	<?php
			...
			header("Expires: 0");
			header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
			header("content-disposition: attachment;filename=Laporan Data Tabungan.doc");
	?>
<body>
...
<head>
	...
	<?php
			...
			header("Expires: 0");
			header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
			header("content-disposition: attachment;filename=Laporan Galat Transaksi.doc");
	?>
<body>
